...
class TestProjectAPI(utils.APITestCase):
    ...
    def assertSerialized(self, project_obj, project_json):
        ...
        self.assertEqual(
            project_obj.parse_dependencies, project_json['parse_dependencies']
        )
    ...
    def test_list_version_1_3(self):
        ...
        self.assertEqual(status.HTTP_200_OK, resp.status_code)
        self.assertEqual(1, len(resp.data))
        self.assertNotIn('parse_dependencies', resp.data[0])
    ...
    def test_detail_version_1_3(self):
        ...
        self.assertNotIn('parse_dependencies', resp.data)
